...
class NearRoute extends HTMLAnchorElement {
    constructor() {
        super();
...
class NearIcon extends i {
  ...
  renderFallback(name) {
    return b`<span class="fallback">${name}</span>`;
  }
...
const nearMenuSurfaceStyles = i$3`
  .near-menu-panel {
...
export { A, E, NearLocation as N, nearControlStyles as a, i$3 as b, b as c, NearRoute as d, i, nearPicoTokens as n };
//# sourceMappingURL=drawerbutton-DZ1isS1h.js.map
